...
DEFECT: would it be better to just return the knot or nil instead of filtering?
$.actor.player.in("cloakroom") returns player if player in cloak room else nil.  To be used for conditionals.
$.actor.player.wears("ring").?tie("is:invisible")
