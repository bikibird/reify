# reify
Reify is a system for creating web-based works of interactive fiction (text adventures) and blurs the lines between parser, choice, and drag/drop based interactive fiction. 
